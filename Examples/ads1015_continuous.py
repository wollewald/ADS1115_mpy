#####################################################################################
# Example program for the ADS1015_mPy module
#
# This program shows how to use the ADS1015 in continuous mode. 
#  
...
i2c = I2C(0)
adc = ADS1015(ADS1015_ADDRESS, i2c=i2c)
...
#   ADS1015_2400_SPS 
#   ADS1015_3300_SPS 
adc.setConvRate(ADS1015_1600_SPS)
...
#   ADS1015_MAX_LIMIT
#   ADS1015_WINDOW
#adc.setAlertModeAndLimit_V(ADS1015_MAX_LIMIT, 3.0, 1.5)
...
while True:
    voltage0 = readChannel(ADS1015_COMP_0_GND)
    voltage1 = readChannel(ADS1015_COMP_1_GND)
    voltage2 = readChannel(ADS1015_COMP_2_GND)
    voltage3 = readChannel(ADS1015_COMP_3_GND)
